...
export const isVisionsTarget = (target: unknown): target is AttackableUnit =>
 ...
 * spell would make.
 */
export default class Malzahar_E extends Spell {
 ...
 */
export function infectWithVisions(
 ...
 */
export class Malzahar_E_Object extends SpellObject {
