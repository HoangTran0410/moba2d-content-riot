...
export function registryFor(owner: AttackableUnit): Syndra_Sphere[] {
 ...
 */
export class Syndra_Sphere extends SpellObject {
...
export function groundedSpheres(owner: AttackableUnit): Syndra_Sphere[] {
...
export default class Syndra_Q extends Spell {
 ...
 */
export class Syndra_Q_Telegraph extends SpellObject {
  zIndex: number | null = GROUND_Z_INDEX;
...
export class Syndra_Q_Fall extends SpellObject {
  age = 0;
  landed = false;
  shards: { angle: number; len: number; drift: number }[] = [];
 ...
 */
export class Syndra_Burst extends SpellObject {
  zIndex: number | null = GROUND_Z_INDEX;
  radius: number;
  lifeTime: number;
  age = 0;
