 ...
 */
export default class Ezreal_E extends Spell {
...
export class Ezreal_E_Bolt extends HomingMissileSpellObject {
  ...
  onTargetArrive(target: AttackableUnit): void {
    target.takeDamage(EZREAL_E_BOLT_DAMAGE, this.owner, 'MAGIC');
    target.addBuff(
      createReveal({
 ...
 */
export class Ezreal_E_Rift extends SpellObject {
  age = 0;
  lifeTime = 320;
  radius = 46;
  incoming = false;
