 ...
 */
export default class Ezreal_W extends Spell {
  ...
  description =
    ...
    ` ${dmg(EZREAL_W_DETONATE_DAMAGE, 'MAGIC')}.` +
...
export function essenceFluxSpell(unit: AttackableUnit): Ezreal_W | null {
 ...
 */
export function detonateEssenceFlux(
...
export class Ezreal_W_Orb extends MissileSpellObject {
 ...
 */
export class Ezreal_W_Mark extends SpellObject {
  target: AttackableUnit;
  age = 0;
...
export class Ezreal_W_Burst extends SpellObject {
  age = 0;
  lifeTime = 340;
  radius = 40;
