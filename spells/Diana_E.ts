...
import { moonlightOn } from './Diana_Q';
...
export class Diana_E_Footfall extends SpellObject {
  lifeTime = 320;
  age = 0;
  private lean = 0;
...
export class Diana_E_Collapse extends SpellObject {
  lifeTime = 320;
  age = 0;
 ...
 */
export class Diana_E_Shatter extends SpellObject {
  lifeTime = 420;
  age = 0;
