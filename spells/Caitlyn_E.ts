 ...
 */
export default class Caitlyn_E extends Spell {
 ...
 */
export class Caitlyn_E_Net extends MissileSpellObject {
  ...
  onHit(enemy: AttackableUnit) {
    enemy.takeDamage(CAITLYN_E_DAMAGE, this.owner, 'MAGIC');
...
export class Caitlyn_E_Tangle extends SpellObject {
  age = 0;
...
export class Caitlyn_E_MuzzleBlast extends SpellObject {
  age = 0;
  lifeTime = 240;
  angle = 0;
