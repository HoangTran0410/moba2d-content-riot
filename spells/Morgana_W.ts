...
export default class Morgana_W extends Spell {
  ...
  description =
    `Nguyền rủa mặt đất tại vị trí chỉ định trong <span class="time">5 giây</span>, gây ${dmgRange(3, 5, 'MAGIC', ' mỗi 0.5 giây', '-')} cho kẻ địch đứng trong đó — sát thương tăng theo phần trăm máu đã mất của mục tiêu, và tăng 70% khi nhắm vào quái rừng.`;
  coolDown = 9_000;
  manaCost = MANA_COST;
...
export class Morgana_W_Object extends AreaSpellObject {
  ...
  private damageTarget(target: ShadowTarget): void {
    ...
    target.takeDamage(base * multiplier, this.owner, 'MAGIC');
  }
