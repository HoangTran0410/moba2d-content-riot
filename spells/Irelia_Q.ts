 ...
 */
export class IreliaMarkBuff extends Buff {
  name = 'Dấu Kiếm';
...
export function findIreliaMark(unit: AttackableUnit): IreliaMarkBuff | null {
...
export function consumeIreliaMark(unit: AttackableUnit): boolean {
...
export function applyIreliaMark(source: AttackableUnit, target: AttackableUnit): void {
 ...
 */
export class Irelia_Mark_Sigil extends SpellObject {
 ...
 */
export class Irelia_Q_Blades extends SpellObject {
  age = 0;
