...
export default class Nautilus_Q extends Spell {
 ...
 */
export class Nautilus_Q_Object extends MissileSpellObject {
  speed = Q_SPEED;
  size = Q_WIDTH;
  maxHitCount = 1;
...
export class Nautilus_Q_Impact extends SpellObject {
  lifeTime = 300;
  age = 0;
  radius = 46;
