 ...
 */
export default class Caitlyn_Q extends Spell {
 ...
 */
export class Caitlyn_Q_Object extends MissileSpellObject {
...
export class Caitlyn_Q_Impact extends SpellObject {
  age = 0;
  lifeTime = 260;
  full = true;
 ...
 */
export class Caitlyn_Q_Brace extends SpellObject {
  age = 0;
