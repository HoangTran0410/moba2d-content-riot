import type { AttackableUnit, Dash } from '@moba2d/core/content/types';
...
export default class Camille_R extends Spell {
 ...
 */
export class Camille_R_Object extends SpellObject {
