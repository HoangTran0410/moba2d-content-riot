 ...
 * localisation.
 *
 * The names in `spells/` were written by hand and drifted:
...
// repository of its own and its spells live directly at its own root
// (`spells/`), not at core's old pre-extraction `src/game/gameObject/
// spells/` — batch 4 had already moved them to `packs/riot/spells/` before
// this pack ever had a repository of its own, and this constant had not
// been updated to follow; fixed here rather than carried forward broken.
