...
const PINNED_MANA_LINES = new Set([
  ...
  "spells/Janna_W.test.ts:170:target.stats.mana.baseValue = 100;",
  ...
  "spells/Pantheon_Q.test.ts:281:expect(caster.stats.mana.value).toBe(75);",
  "spells/Pantheon_Q.test.ts:308:expect(caster.stats.mana.value).toBe(87.5);",
  "spells/Pantheon_Q.test.ts:314:stats.mana.baseValue = 100;",
  "spells/Pantheon_Q.test.ts:319:expect(stats.mana.baseValue).toBe(87.5);",
