...
const PINNED_MANA_LINES = new Set([
  ...
  "spells/Anivia_R.test.ts:205:expect(owner.stats.mana.value).toBe(startingMana - MANA_COST);",
  "spells/Anivia_R.test.ts:208:expect(owner.stats.mana.value).toBe(startingMana - MANA_COST - UPKEEP_COST);",
  "spells/Anivia_R.test.ts:217:const startingMana = owner.stats.mana.value;",
  "spells/Anivia_R.test.ts:220:expect(owner.stats.mana.value).toBe(startingMana);",
  "spells/Anivia_R.test.ts:223:expect(owner.stats.mana.value).toBe(startingMana);",
  "spells/Anivia_R.test.ts:270:owner.stats.mana.baseValue = 0;",
  "spells/Anivia_W.test.ts:48:unit.stats.mana.baseValue = 100;",
  "spells/Annie_QE.test.ts:53:unit.stats.mana.baseValue = 500;",
  "spells/Brand.test.ts:39:result.stats.mana.baseValue = 300;",
  "spells/Caitlyn.test.ts:39:result.stats.mana.baseValue = 200;",
  "spells/Camille.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Diana.test.ts:43:result.stats.mana.baseValue = 500;",
  "spells/Ekko.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Ezreal.test.ts:104:owner.stats.mana.baseValue = 10;",
  "spells/Ezreal.test.ts:106:expect(owner.stats.mana.value).toBe(10);",
  "spells/Ezreal.test.ts:38:result.stats.mana.baseValue = 100;",
  "spells/Ezreal.test.ts:95:owner.stats.mana.baseValue = 10;",
  "spells/Ezreal.test.ts:98:expect(owner.stats.mana.value).toBe(10 + EZREAL_W_MANA_REFUND);",
  "spells/Irelia.test.ts:141:const manaBefore = owner.stats.mana.baseValue;",
  ...
  "spells/Janna_W.test.ts:33:result.stats.mana.baseValue = 100;",
  "spells/Janna_W.test.ts:43:result.stats.mana.baseValue = 100;",
  "spells/JarvanIV.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:135:expect(owner.stats.mana.value).toBe(100);",
  "spells/Jhin.test.ts:340:owner.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:371:owner.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:42:result.stats.mana.baseValue = 100;",
  "spells/Katarina.test.ts:43:result.stats.mana.baseValue = 100;",
  "spells/Leblanc_R.test.ts:159:owner.stats.mana.baseValue = 500;",
  "spells/Leblanc_R.test.ts:172:const manaAfterQ = owner.stats.mana.value;",
  "spells/Leblanc_R.test.ts:198:expect(owner.stats.mana.value).toBe(manaAfterQ);",
  "spells/Lux_R.test.ts:291:expect(owner.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Malphite_E.test.ts:105:expect(owner.stats.mana.value).toBe(100 - spell.manaCost);",
  "spells/Malphite_E.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Malphite_Q.test.ts:111:owner.stats.mana.baseValue = 500;",
  "spells/Malphite_Q.test.ts:153:expect(owner.stats.mana.value).toBe(100);",
  "spells/Malphite_Q.test.ts:33:result.stats.mana.baseValue = 100;",
  "spells/Malphite_W.test.ts:23:result.stats.mana.baseValue = 100;",
  "spells/Malzahar.test.ts:184:const manaBefore = malzahar.stats.mana.value;",
  "spells/Malzahar.test.ts:190:expect(malzahar.stats.mana.value - manaBefore).toBe(MANA_ON_KILL);",
  "spells/Malzahar.test.ts:65:champion.stats.mana.baseValue = 500;",
  "spells/MasterYi.test.ts:58:champion.stats.mana.baseValue = 500;",
  "spells/Morgana_W.test.ts:81:expect(owner.stats.mana.value).toBe(500 - MANA_COST);",
  "spells/Nautilus.test.ts:81:result.stats.mana.baseValue = 100;",
  "spells/Pantheon_Q.test.ts:286:expect(caster.stats.mana.value).toBe(75);",
  "spells/Pantheon_Q.test.ts:313:expect(caster.stats.mana.value).toBe(87.5);",
  "spells/Pantheon_Q.test.ts:319:stats.mana.baseValue = 100;",
  "spells/Pantheon_Q.test.ts:324:expect(stats.mana.baseValue).toBe(87.5);",
  "spells/Rammus_WE.test.ts:47:unit.stats.mana.baseValue = 500;",
  "spells/Riven.test.ts:27:result.stats.mana.baseValue = 100;",
  "spells/Sett.test.ts:39:unit.stats.mana.baseValue = 100;",
  "spells/Soraka.test.ts:37:result.stats.mana.baseValue = 200;",
  "spells/Syndra.test.ts:35:result.stats.mana.baseValue = 100;",
  "spells/Teemo_E.test.ts:249:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Teemo_W.test.ts:87:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Varus_Q.test.ts:250:expect(caster.stats.mana.value).toBe(100 - MANA_COST / 2);",
  "spells/Varus_Q.test.ts:277:expect(caster.stats.mana.value).toBe(100 - MANA_COST / 2);",
  "spells/Varus_Q.test.ts:283:stats.mana.baseValue = 100;",
  "spells/Varus_Q.test.ts:288:expect(stats.mana.baseValue).toBe(100 - MANA_COST / 2);",
  "spells/Vayne.test.ts:46:result.stats.mana.baseValue = 100;",
  "spells/Veigar_Q.test.ts:107:caster.stats.mana.baseValue = 200;",
  "spells/Veigar_Q.test.ts:111:expect(caster.stats.mana.value).toBe(200 + spell.manaPerStack);",
  "spells/Veigar_Q.test.ts:122:expect(caster.stats.mana.value).toBe(caster.stats.maxMana.value);",
  "spells/Veigar_Q.test.ts:45:unit.stats.mana.baseValue = 500;",
  "spells/Veigar_R.test.ts:131:expect(owner.stats.mana.value).toBe(200); // committed at release, not start",
  "spells/Veigar_R.test.ts:138:expect(owner.stats.mana.value).toBe(200);",
  "spells/Veigar_R.test.ts:151:expect(owner.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Veigar_R.test.ts:31:result.stats.mana.baseValue = 200;",
  "spells/Veigar_W.test.ts:97:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Vi.test.ts:34:result.stats.mana.baseValue = 100;",
  "spells/Warwick_R.test.ts:45:owner.stats.mana.baseValue = 500;",
  "spells/XinZhao.test.ts:40:unit.stats.mana.baseValue = 200;",
  "spells/Ziggs.test.ts:36:result.stats.mana.baseValue = 100;",
]);
...
const PINNED_RESOURCE_LINES = new Set([
  ...
  "spells/Janna_R.test.ts:167:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:134:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:284:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:362:stats: { mana: { value: 500 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:430:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Pantheon_Q.test.ts:65:health: { value: health },",
  "spells/Pantheon_Q.test.ts:91:stats: { mana, health: { value: 100 }, addModifier: vi.fn(), removeModifier: vi.fn() },",
  "spells/Teemo_E.test.ts:58:stats: { mana: manaStat, health: { value: 100 } },",
  "spells/Teemo_W.test.ts:57:stats: { mana: manaStat, health: { value: 100 } },",
  "spells/Varus_Q.test.ts:53:stats: { mana, health: { value: 100 }, addModifier: vi.fn(), removeModifier: vi.fn() },",
  "spells/Veigar_W.test.ts:59:stats: { mana: manaStat, health: { value: 100 } },",
]);
