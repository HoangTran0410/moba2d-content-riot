...
const PINNED_MANA_LINES = new Set([
  ...
  "representative-spells.test.ts:223:expect(luxOwner.stats.mana.value).toBe(200 - luxR.manaCost);",
  "representative-spells.test.ts:233:expect(jannaROwner.stats.mana.value).toBe(200 - jannaR.manaCost);",
  "representative-spells.test.ts:243:expect(jannaQOwner.stats.mana.value).toBe(200 - jannaQ.manaCost);",
  "representative-spells.test.ts:254:expect(aniviaOwner.stats.mana.value).toBe(200 - aniviaR.manaCost);",
  "representative-spells.test.ts:258:expect(aniviaOwner.stats.mana.value).toBe(200 - aniviaR.manaCost);",
  "representative-spells.test.ts:269:expect(varusOwner.stats.mana.value).toBe(200 - varusQ.manaCost);",
  "representative-spells.test.ts:278:expect(tapOwner.stats.mana.value).toBe(200 - tapQ.manaCost);",
  "representative-spells.test.ts:292:expect(holdOwner.stats.mana.value).toBe(200 - holdQ.manaCost);",
  "representative-spells.test.ts:300:owner.stats.mana.baseValue = 200;",
  "representative-spells.test.ts:306:expect(owner.stats.mana.value).toBe(200);",
  "representative-spells.test.ts:312:expect(owner.stats.mana.value).toBe(200);",
  "representative-spells.test.ts:316:expect(owner.stats.mana.value).toBe(200 - spell.manaCost);",
  "spells/Anivia_E.test.ts:22:result.stats.mana.baseValue = 100;",
  "spells/Anivia_R.test.ts:194:const startingMana = owner.stats.mana.value;",
  "spells/Anivia_R.test.ts:197:expect(owner.stats.mana.value).toBe(startingMana - MANA_COST);",
  "spells/Anivia_R.test.ts:199:expect(owner.stats.mana.value).toBe(startingMana - MANA_COST);",
  "spells/Anivia_R.test.ts:202:expect(owner.stats.mana.value).toBe(startingMana - MANA_COST - UPKEEP_COST);",
  "spells/Anivia_R.test.ts:211:const startingMana = owner.stats.mana.value;",
  "spells/Anivia_R.test.ts:214:expect(owner.stats.mana.value).toBe(startingMana);",
  "spells/Anivia_R.test.ts:217:expect(owner.stats.mana.value).toBe(startingMana);",
  "spells/Anivia_R.test.ts:264:owner.stats.mana.baseValue = 0;",
  "spells/Anivia_W.test.ts:45:unit.stats.mana.baseValue = 100;",
  "spells/Annie_QE.test.ts:50:unit.stats.mana.baseValue = 500;",
  "spells/Brand.test.ts:28:result.stats.mana.baseValue = 300;",
  "spells/Caitlyn.test.ts:30:result.stats.mana.baseValue = 200;",
  "spells/Camille.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Diana.test.ts:37:result.stats.mana.baseValue = 500;",
  "spells/Ekko.test.ts:22:result.stats.mana.baseValue = 100;",
  "spells/Ezreal.test.ts:96:owner.stats.mana.baseValue = 10;",
  "spells/Ezreal.test.ts:98:expect(owner.stats.mana.value).toBe(10);",
  "spells/Ezreal.test.ts:30:result.stats.mana.baseValue = 100;",
  "spells/Ezreal.test.ts:87:owner.stats.mana.baseValue = 10;",
  "spells/Ezreal.test.ts:90:expect(owner.stats.mana.value).toBe(10 + EZREAL_W_MANA_REFUND);",
  "spells/Irelia.test.ts:128:const manaBefore = owner.stats.mana.baseValue;",
  "spells/Irelia.test.ts:131:expect(owner.stats.mana.baseValue).toBe(manaBefore);",
  "spells/Irelia.test.ts:141:expect(owner.stats.mana.baseValue).toBe(100 - q.manaCost);",
  "spells/Irelia.test.ts:35:result.stats.mana.baseValue = 100;",
  "spells/Janna_E.test.ts:24:result.stats.mana.baseValue = 10_000;",
  "spells/Janna_Q.test.ts:161:expect(owner.stats.mana.value).toBe(100 - spell.manaCost);",
  "spells/Janna_R.test.ts:253:expect(owner.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Janna_W.test.ts:176:target.stats.mana.baseValue = 100;",
  "spells/Janna_W.test.ts:26:result.stats.mana.baseValue = 100;",
  "spells/Janna_W.test.ts:36:result.stats.mana.baseValue = 100;",
  "spells/JarvanIV.test.ts:22:result.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:122:expect(owner.stats.mana.value).toBe(100);",
  "spells/Jhin.test.ts:327:owner.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:358:owner.stats.mana.baseValue = 100;",
  "spells/Jhin.test.ts:29:result.stats.mana.baseValue = 100;",
  "spells/Katarina.test.ts:34:result.stats.mana.baseValue = 100;",
  "spells/Leblanc_R.test.ts:150:owner.stats.mana.baseValue = 500;",
  "spells/Leblanc_R.test.ts:163:const manaAfterQ = owner.stats.mana.value;",
  "spells/Leblanc_R.test.ts:189:expect(owner.stats.mana.value).toBe(manaAfterQ);",
  "spells/Lux_R.test.ts:283:expect(owner.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Malphite_E.test.ts:102:expect(owner.stats.mana.value).toBe(100 - spell.manaCost);",
  "spells/Malphite_E.test.ts:23:result.stats.mana.baseValue = 100;",
  "spells/Malphite_Q.test.ts:108:owner.stats.mana.baseValue = 500;",
  "spells/Malphite_Q.test.ts:150:expect(owner.stats.mana.value).toBe(100);",
  "spells/Malphite_Q.test.ts:30:result.stats.mana.baseValue = 100;",
  "spells/Malphite_W.test.ts:20:result.stats.mana.baseValue = 100;",
  "spells/Malzahar.test.ts:170:const manaBefore = malzahar.stats.mana.value;",
  "spells/Malzahar.test.ts:176:expect(malzahar.stats.mana.value - manaBefore).toBe(MANA_ON_KILL);",
  "spells/Malzahar.test.ts:51:champion.stats.mana.baseValue = 500;",
  "spells/MasterYi.test.ts:52:champion.stats.mana.baseValue = 500;",
  "spells/Morgana_W.test.ts:78:expect(owner.stats.mana.value).toBe(500 - MANA_COST);",
  "spells/Nautilus.test.ts:72:result.stats.mana.baseValue = 100;",
  "spells/Pantheon_Q.test.ts:285:expect(caster.stats.mana.value).toBe(75);",
  "spells/Pantheon_Q.test.ts:312:expect(caster.stats.mana.value).toBe(87.5);",
  "spells/Pantheon_Q.test.ts:318:stats.mana.baseValue = 100;",
  "spells/Pantheon_Q.test.ts:323:expect(stats.mana.baseValue).toBe(87.5);",
  "spells/Rammus_WE.test.ts:45:unit.stats.mana.baseValue = 500;",
  "spells/Riven.test.ts:23:result.stats.mana.baseValue = 100;",
  "spells/Sett.test.ts:33:unit.stats.mana.baseValue = 100;",
  "spells/Soraka.test.ts:28:result.stats.mana.baseValue = 200;",
  "spells/Syndra.test.ts:27:result.stats.mana.baseValue = 100;",
  "spells/Teemo_E.test.ts:245:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Teemo_W.test.ts:84:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Varus_Q.test.ts:246:expect(caster.stats.mana.value).toBe(100 - MANA_COST / 2);",
  "spells/Varus_Q.test.ts:273:expect(caster.stats.mana.value).toBe(100 - MANA_COST / 2);",
  "spells/Varus_Q.test.ts:279:stats.mana.baseValue = 100;",
  "spells/Varus_Q.test.ts:284:expect(stats.mana.baseValue).toBe(100 - MANA_COST / 2);",
  "spells/Vayne.test.ts:41:result.stats.mana.baseValue = 100;",
  "spells/Veigar_Q.test.ts:102:caster.stats.mana.baseValue = 200;",
  "spells/Veigar_Q.test.ts:106:expect(caster.stats.mana.value).toBe(200 + spell.manaPerStack);",
  "spells/Veigar_Q.test.ts:117:expect(caster.stats.mana.value).toBe(caster.stats.maxMana.value);",
  "spells/Veigar_Q.test.ts:40:unit.stats.mana.baseValue = 500;",
  "spells/Veigar_R.test.ts:126:expect(owner.stats.mana.value).toBe(200); // committed at release, not start",
  "spells/Veigar_R.test.ts:133:expect(owner.stats.mana.value).toBe(200);",
  "spells/Veigar_R.test.ts:146:expect(owner.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Veigar_R.test.ts:26:result.stats.mana.baseValue = 200;",
  "spells/Veigar_W.test.ts:92:expect(caster.stats.mana.value).toBe(200 - MANA_COST);",
  "spells/Vi.test.ts:30:result.stats.mana.baseValue = 100;",
  "spells/Warwick_R.test.ts:44:owner.stats.mana.baseValue = 500;",
  "spells/XinZhao.test.ts:34:unit.stats.mana.baseValue = 200;",
  "spells/Ziggs.test.ts:28:result.stats.mana.baseValue = 100;",
]);
...
const PINNED_RESOURCE_LINES = new Set([
  ...
  "representative-spells.test.ts:89:mana: { value: mana },",
  "representative-spells.test.ts:90:health: { value: 100 },",
  "spells/Anivia_R.test.ts:95:stats: { mana: manaStat, health: { value: 100 } },",
  "spells/Ashe_R.test.ts:72:stats: { mana: { value: 100 }, health: { value: 100 } },",
  "spells/Janna_Q.test.ts:68:stats: { mana: { value: 100 }, health: { value: 100 } },",
  "spells/Janna_R.test.ts:197:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:126:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:276:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:354:stats: { mana: { value: 500 }, health: { value: 100 } },",
  "spells/Lux_R.test.ts:422:stats: { mana: { value: 200 }, health: { value: 100 } },",
  "spells/Pantheon_Q.test.ts:60:health: { value: health },",
  "spells/Pantheon_Q.test.ts:86:stats: { mana, health: { value: 100 }, addModifier: vi.fn(), removeModifier: vi.fn() },",
  "spells/Teemo_E.test.ts:54:stats: { mana: manaStat, health: { value: 100 } },",
  "spells/Teemo_W.test.ts:54:stats: { mana: manaStat, health: { value: 100 } },",
  "spells/Varus_Q.test.ts:49:stats: { mana, health: { value: 100 }, addModifier: vi.fn(), removeModifier: vi.fn() },",
  "spells/Veigar_W.test.ts:54:stats: { mana: manaStat, health: { value: 100 } },",
]);
